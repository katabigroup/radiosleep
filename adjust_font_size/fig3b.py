...
fig_boxplot, ax_boxplot = plt.subplots(1, 1, figsize=(5, 5))
...
ax_boxplot.set_xlabel("PSG Labeled AHI", fontsize=fontsize)
ax_boxplot.set_ylabel("Predicted AHI", fontsize=fontsize)
ax_boxplot.tick_params('y', labelsize=fontsize)
ax_boxplot.tick_params('x', labelsize=fontsize, rotation=25)

# save the boxplot for fig_boxplot
# fig_boxplot.tight_layout(pad=0.5)
